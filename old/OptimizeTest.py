...
y_hero = 100
map_number = [0, 0]
ground.blit(pygame.image.load('data/maps/lvl1/map0_0l1.jpg'), (50, 50))
sound_button = False
music_button = False
camera_mode = 0
...
while menu_flag:
    ...
    display.update()
menu_button = 2 # сброс кнопки в главном меню игры
...
while game_flag:
    ...
    if moving[0] ==  True and stoper(map_number, x_hero, y_hero, 3): x_hero  -= 10
    if moving[1] ==  True and stoper(map_number, x_hero, y_hero, 2): x_hero  += 10
    if moving[3] ==  True and stoper(map_number, x_hero, y_hero, 0): y_hero  += 10
    if moving[2] ==  True and stoper(map_number, x_hero, y_hero, 1): y_hero  -= 10
    ...
    if x_hero < -25:
        map_number[0] -= 1
        x_hero = 1255
        ground.blit(pygame.image.load(map_name + str(map_number[0]) + '_' + str(map_number[1]) + 'l1.jpg'), (50, 50))
        reload = True
    elif x_hero > 1255:
        map_number[0] += 1
        x_hero = -25
